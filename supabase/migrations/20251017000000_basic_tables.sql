...
-- Ensure invite_code column exists for legacy databases where invitations table predates this column
ALTER TABLE invitations ADD COLUMN IF NOT EXISTS invite_code TEXT;
...
-- Ensure a unique index exists for invite_code
DO $$ BEGIN
  CREATE UNIQUE INDEX IF NOT EXISTS invitations_invite_code_key ON invitations(invite_code);
EXCEPTION
