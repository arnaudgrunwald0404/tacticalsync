...
| Inbox | `inbox_items`, `inbox_tags`, `inbox_item_tags`, `inbox_views`, `dci_suggested_tasks`, `sources_triage_preferences`, `email_dismissal_log` |
