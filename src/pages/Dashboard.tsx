...
// Deprecated: legacy dashboard for the old RCDO meetings feature
// (meeting_series/meeting_instances), superseded by DashboardMain and no
// longer reachable from any route. Already unreferenced before this comment
// was added — kept only as historical reference.
