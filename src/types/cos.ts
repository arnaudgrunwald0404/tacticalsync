// Chief of Staff layout configuration types
...
// Legacy types — only used by migrateOldSettings()
export interface CosCol1Section { key: string; label: string | null; auto_label: boolean; enabled: boolean; }
export interface CosCol2Section { key: string; label: string; enabled: boolean; }

export const DEFAULT_STATUS_OPTIONS = ['WIP', 'WOS', 'Done'];

export const AUTO_SECTION_TYPES: CosSectionType[] = [
