...
export function DODialog({
  ...
  }, [isOpen, cycleStartDate, cycleEndDate]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          rallying_cry_id: createData.rallying_cry_id,
          title: createData.title,
          hypothesis: createData.hypothesis || null,
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a crisp, outcome-focused objective that supports your rallying cry.
          </DialogDescription>
        </DialogHeader>
