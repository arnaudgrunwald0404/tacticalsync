...
export default function CosZoomSyncPanel() {
  ...
  const connect = () => {
    ...
    const scopes = 'user:read:user meeting:read:list_meetings meeting:read:meeting cloud_recording:read:list_user_recordings cloud_recording:read:list_recording_files meeting:read:summary meeting:read:list_past_instances cloud_recording:read:meeting_transcript docs:read:file docs:read:list_children docs:read:export docs:write:export';
